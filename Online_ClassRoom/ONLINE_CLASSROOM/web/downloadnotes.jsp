<%-- 
    Document   : downloadnotes
    Created on : Feb 29, 2016, 8:21:01 AM
    Author     : user
--%>
...
<html>
    ...
    <center>
        ...
        <%
            ...
            out.println("<center>");
            out.println("<form action='downloadnotes.jsp' method='post'>");
    ...
    <%
        ...
        if (name == null) {
            ...
            if (name.equalsIgnoreCase("select")) {
                ...
                PreparedStatement st2 = con.prepareStatement("select * from add_note where SubjectName=?");
                ...
                while (rs2.next()) {
                    ...
                    out.print("</td>");
                    out.print("<td>");
                    out.print(rs2.getString("TopicName"));
                    out.print("</td>");
                    out.println("<td>");
                    out.print(rs2.getString("NotesFile"));
                    out.print("</td>");
                    out.print("<td>");
                    out.print(rs2.getString("idadd_note"));
                    out.print("</td>");
                    i++;
                }
                out.println("</table>");
...
<form action="notesdownload.jsp" method="post">
    <center>

        <table bgcolor="cyan">
            <caption><font color="red">Here You Can DownLoad Notes</font></caption>
            <tr>
                <td>
                    Enter Notes Id:  
                </td>
