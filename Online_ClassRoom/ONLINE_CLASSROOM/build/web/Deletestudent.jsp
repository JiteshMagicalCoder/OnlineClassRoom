...
<html>
    ...
    <center>
        <h3> <font color="red">List Of Registered Candidate</font></h3>
        ...
        <%
            ...
            PreparedStatement st1 = con1.prepareStatement("select * from registration");
            ResultSet rs1 = st1.executeQuery();
            out.print("<center>");
         
            out.print("<form bgcolor  action='Deletestudent'>");
            ...
            out.print(" Enter Email Id of student:<input type='text' name='email' required=''>");
